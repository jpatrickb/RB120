...
# the #initialize methods in Graduate and Undergraduate are missing. Fill in those missing 
# details so that the following requirements are fulfilled:

# 1 . Graduate students have the option to use on-campus parking, while Undergraduate students 
# do not.
